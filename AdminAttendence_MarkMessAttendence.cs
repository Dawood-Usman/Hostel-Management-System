...
{
    public partial class AdminAttendence_MarkMessAttendence : Form
    {
        ...
        public AdminAttendence_MarkMessAttendence()
        {
            InitializeComponent();
        }

        private void AA_MarkMAExit_Click(object sender, EventArgs e)
        {
        ...
        {
            if (RNTextBox.Text == "" || MTComboBox.Text == "" || StatusComboBox.Text == "")
            {
                return true;
            }
            else
        ...
        private void MarkAttendenceBtn_Click(object sender, EventArgs e)
        {
            if (!IstextBoxesEmpty())
            {
                ...
                string query2 = "Insert Into Mess_Attendence Values(@RN, @MT, @AS, @Date)";
                ...
                cmd2.Parameters.AddWithValue("@MT", MTComboBox.SelectedItem);
